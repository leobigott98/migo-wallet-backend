...
const clientConfig = {
    auth: {
      clientId: process.env.MSAL_WEBHOOK_CLIENT_ID,
      authority: process.env.MSAL_AUTHORITY,
      clientSecret: process.env.MSAL_WEBHOOK_CLIENT_SECRET,
    },
  };
  ...
  const clientCredentialRequest = {
    scopes: [process.env.MSAL_WEBHOOK_SCOPE], // replace with your resource
  };
